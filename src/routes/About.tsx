        ...
        <section
            ...
            <div className='opacity-0 fade'>
                ...
                <div className='font-lexend my-[3.75rem] xl:mt-10'>
                    ...
                    <article className='mt-6 pb-8 border-b-[1px] border-[grey] border-opacity-30'>
                        <div className='md:w-2/3 lg:w-1/2'>
                            <div className='flex flex-col gap-4'>
                    ...
                    <article className='mt-6'>
                        <div className='md:w-2/3 lg:w-1/2'>
                            ...
                            <div className='tracking-[-0.3px] mt-6 flex flex-col gap-2'>
                                ...
                                <p className='text-[#ffffff90] leading-[1.7em]'>
                                    Created a captivating landing page for a new
                                    financial product and also played a crucial
                                    role in debugging several web pages,
                                    addressing performance issues and resolving
